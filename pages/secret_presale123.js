...
export default function Presale() {
  ...
  async function mint_presale(){
      ...
      if(Web3.givenProvider ){ 
        ...
        try{
          const estemated_Gas = await contract.methods.buy_Presale(value.toString()).estimateGas({
            from : address, 
          ...
          const result = await contract.methods.buy_Presale(value.toString()).send({
            from : address,
            value: web3.utils.toWei(price.toString(),"ether"),
            gas: estemated_Gas,
            maxPriorityFeePerGas: null,
  ...
  async function mint_nft(){
    if(Web3.givenProvider ){ 
        ...
        try{
          const estemated_Gas = await contract.methods.buy(value.toString()).estimateGas({
            from : address, 
            value: web3.utils.toWei(price.toString(),"ether"),
            maxPriorityFeePerGas: null,
            maxFeePerGas: null
            ...
            <div className="main-box">
              ...
              <div className="right-detail">
                ...
                <p className="p-2">
                  ...
                  Australian Conservation Foundation (ACF) to help breed and
                  protect the species.
                </p>
        ...
        <div className="sec4-wrapper">
          <div className="container sec-4">
            <div className="footer-links">
              ...
              <a target="_blank" href="https://discord.gg/3JCxP7grsm">
                {" "}
          ...
          <div className="container sec-3">
            ...
            <div className="row-2">
              ...
              <div className="row2-wrap">
                ...
                <p>
                  1. Creating a mobile game with Aussie Adrenaline Game Studios based on the
                  Tokenpuss character. Huge perks for token owners. Coming soon!
                  <br />
                  2.  We’re proud to create a unique project with a
            ...
            <div className="row-3">
              <div className="centr-box">
                ...
                <button className="mint-btn" onClick={mint_presale}>
                  <img alt="eth54" src={"/Cart-min.png"} />
                  <span>MINT</span>
                </button>
              </div>
